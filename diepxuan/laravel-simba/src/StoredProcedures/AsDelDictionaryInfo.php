...
/**
 * Class AsDelDictionaryInfo
 *
 * Stored procedure: asDelDictionaryInfo
 * Mục đích: Xóa một bản ghi từ bảng sysDictionaryInfo dựa trên mã code_name.
 * Procedure thực hiện DELETE từ bảng sysDictionaryInfo với điều kiện khớp Code_name.
 * 
 * Tham số:
 ...
 * 
 * Logic chi tiết:
 * - DELETE FROM sysDictionaryInfo WHERE Code_name = @pCode_name
 * - SET @pRet = @@error
 * 
 * Ví dụ gọi:
 * ```php
 * $result = AsDelDictionaryInfo::call([
 *     'pCode_name' => 'DICT001',
 * ]);
 ...
 * - Bảng sysDictionaryInfo lưu thông tin từ điển (danh mục đơn giản).
...
{
    /**
     * Gọi stored procedure asDelDictionaryInfo
     *
    ...
    public static function call(array $params = [])
    {
        ...
        return ProcedureCaller::call('asDelDictionaryInfo', $params);
    }
}