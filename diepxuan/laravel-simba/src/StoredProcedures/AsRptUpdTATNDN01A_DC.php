 ...
 *
 * Stored procedure: asRptUpdTATNDN01A_DC
 * Mục đích: Cập nhật trường tiền (tien) trong bảng TATNDN01A_DC (báo cáo thuế thu nhập doanh nghiệp - mẫu 01A điều chỉnh).
 * Procedure thực hiện cập nhật giá trị tiền cho một bản ghi cụ thể trong bảng điều chỉnh TATNDN01A_DC dựa trên các điều kiện:
 ...
 * 
 * Lưu ý:
 * - Bảng TATNDN01A_DC lưu trữ dữ liệu điều chỉnh của tờ khai thuế thu nhập doanh nghiệp mẫu 01A.
...
{
    /**
     * Gọi stored procedure asRptUpdTATNDN01A_DC
     *
    ...
    public static function call(array $params = [])
    {
        ...
        return ProcedureCaller::call('asRptUpdTATNDN01A_DC', $params);
    }
}